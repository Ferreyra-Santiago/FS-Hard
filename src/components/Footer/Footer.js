...
<footer className="p-4 bg-white shadow md:px-6 md:py-8">
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <img className=" ml-8 h-20 w-40" src={logo} alt="Logo" />
        </a>
        <ul className="flex flex-wrap items-center mb-6 text-sm text-gray-700 sm:mb-0">
            ...
            <li>
                <a href="/product" className="mr-4 hover:underline md:mr-6">Productos</a>
            </li>
            <li>
    ...
    <div className="mt-3 sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-700 sm:text-center">© 2022 <a href="/" className="hover:underline">Systematic</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="https://www.instagram.com/systematic.stw/" className="text-gray-700 hover:text-gray-900">
